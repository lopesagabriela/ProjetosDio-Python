...
df = pd.read_excel(r"C:\Users\Home\Desktop\Documentos\Curso Python Dio\AnaliseDadosPandas\AdventureWorks.xlsx")

df.head()   #valor da venda = receita = Quantidade x Preço Unitário

#verifica se há valores faltantes na base de dados:

df.isnull().sum() # não tem valores ausentes
